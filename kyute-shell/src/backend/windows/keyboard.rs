// This file contains code borrowed from the Druid project (https://github.com/linebender/druid)
//
...
use windows::Win32::{
    ...
    UI::{
        Input::KeyboardAndMouse::{
            VkKeyScanW, VK_ACCEPT, VK_APPS, VK_ATTN, VK_BACK, VK_BROWSER_BACK, VK_BROWSER_FAVORITES,
            VK_BROWSER_FORWARD, VK_BROWSER_HOME, VK_BROWSER_REFRESH, VK_BROWSER_SEARCH, VK_BROWSER_STOP, VK_CANCEL,
            VK_CAPITAL, VK_CLEAR, VK_CONTROL, VK_CONVERT, VK_CRSEL, VK_DELETE, VK_DOWN, VK_END, VK_EREOF, VK_ESCAPE,
            VK_EXECUTE, VK_EXSEL, VK_F1, VK_F10, VK_F11, VK_F12, VK_F13, VK_F14, VK_F15, VK_F16, VK_F17, VK_F18,
            VK_F19, VK_F2, VK_F20, VK_F21, VK_F22, VK_F23, VK_F24, VK_F3, VK_F4, VK_F5, VK_F6, VK_F7, VK_F8, VK_F9,
            VK_FINAL, VK_HELP, VK_HOME, VK_INSERT, VK_JUNJA, VK_KANA, VK_KANJI, VK_LAUNCH_APP1, VK_LAUNCH_APP2,
            VK_LAUNCH_MAIL, VK_LAUNCH_MEDIA_SELECT, VK_LCONTROL, VK_LEFT, VK_LWIN, VK_MEDIA_NEXT_TRACK,
            VK_MEDIA_PLAY_PAUSE, VK_MEDIA_PREV_TRACK, VK_MEDIA_STOP, VK_MENU, VK_MODECHANGE, VK_NEXT, VK_NONCONVERT,
            VK_NUMLOCK, VK_OEM_ATTN, VK_OEM_CLEAR, VK_PAUSE, VK_PLAY, VK_PRINT, VK_PRIOR, VK_PROCESSKEY, VK_RETURN,
            VK_RIGHT, VK_RMENU, VK_SCROLL, VK_SELECT, VK_SHIFT, VK_SLEEP, VK_SNAPSHOT, VK_TAB, VK_UP, VK_VOLUME_DOWN,
            VK_VOLUME_MUTE, VK_VOLUME_UP, VK_ZOOM,
        },
        WindowsAndMessaging::{PeekMessageW, PM_NOREMOVE},
    },
};
...
const SCAN_MASK: u32 = 0x1ff_0000;
...
fn vk_to_location(vk: VkCode, is_extended: bool) -> Location {
    match vk as INT {
        ...
        VK_INSERT | VK_DELETE | VK_END | VK_DOWN | VK_NEXT | VK_LEFT | VK_CLEAR | VK_RIGHT | VK_HOME | VK_UP
        | VK_PRIOR => {
            if is_extended {
                Location::Standard
            } else {
        ...
        | VK_NUMPAD8 | VK_NUMPAD9 | VK_DECIMAL | VK_DIVIDE | VK_MULTIPLY | VK_SUBTRACT | VK_ADD | VK_ABNT_C2 => {
            Location::Numpad
        }
        _ => Location::Standard,
    }
